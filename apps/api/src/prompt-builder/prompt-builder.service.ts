...
export class PromptBuilderService {
  build(
    ...
    const system = [
      ...
      '  title, hook, facebook, telegram, instagram, reels, imagePrompt, hashtags',
      '- facebook must contain caption and discussionQuestion.',
      '- telegram must contain message and callToAction.',
      '- instagram must contain a concise caption and relevant hashtags suitable for an Instagram Business post.',

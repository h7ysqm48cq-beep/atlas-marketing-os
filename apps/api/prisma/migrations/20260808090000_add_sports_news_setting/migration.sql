...
CREATE UNIQUE INDEX "SportsNewsSetting_workspaceId_key" ON "SportsNewsSetting"("workspaceId");
ALTER TABLE "SportsNewsSetting" ADD CONSTRAINT "SportsNewsSetting_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "SportsNewsSetting" ADD CONSTRAINT "SportsNewsSetting_telegramChannelId_fkey" FOREIGN KEY ("telegramChannelId") REFERENCES "SocialChannel"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "SportsNewsSetting" ADD CONSTRAINT "SportsNewsSetting_facebookChannelId_fkey" FOREIGN KEY ("facebookChannelId") REFERENCES "SocialChannel"("id") ON DELETE SET NULL ON UPDATE CASCADE;
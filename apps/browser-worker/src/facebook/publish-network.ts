...
async function inspectResponse(response: Response) {
  ...
  // Facebook keeps some GraphQL responses open while the composer settles.
  // Never let network diagnostics hold the publish request open behind that
  // stream; status/path remain useful signals when the body is not finished.

...
MANIFEST = {
    "id": "008A",
    "name": "Atlas Project Analyzer",
    "version": "0.8.0",
    "requires": ["006A", "007A"],
    "description": (
        "Adds a repository analyzer that detects workspace scripts, "
        "NestJS modules, controllers, services and TypeScript imports."
    ),
    "build": [],
}
...
def apply(context: PatchContext) -> None:
    ...
    context.append_once(
        ".gitignore",
        """
# Atlas analyzer generated output
tools/project-manifest.json
""",
    )
